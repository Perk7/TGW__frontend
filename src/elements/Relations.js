    ...
    function getContracts() {
        ...
        for (let i of getWars(
            ...
            if (
                ...
                arr.push(
                    <li
                        key={`${props.country}_DW-invite-${i.ident}`}
                        data-con={`${props.country}_DW-invite-${i.ident}`}
                        style={
                            props.store.changeGame.indexOf(
                                `contract_${props.country}_DW-invite-${i.ident}`
                            ) !== -1
                                ? { backgroundColor: "#777" }
                                : null
                        }
        ...
        for (let i of Object.keys(cons)) {
            ...
            let item = cons[i].status ? (
                <li
                    ...
                    data-con={iden}
                    style={
                        props.store.changeGame.indexOf(`contract_${iden}`) !==
                        -1
                            ? { backgroundColor: "#777" }
                            : null
                    }
                    ...
                    <ul
                        onClick={(ev) => {
                            ...
                            if (ev.target.dataset.con) {
                                if (
                                    ev.target.dataset.con.indexOf("FW") !== -1
                                ) {
                                    return;
                                }
                            }
                            if (ev.target.parentElement.dataset.con) {
                                if (
                                    ev.target.parentElement.dataset.con.indexOf(
                                        "FW"
                                    ) !== -1
                                ) {
                                    return;
                            ...
                            let name =
                                ev.target.dataset.con ||
                                ev.target.parentElement.dataset.con;
